...
var html=$("html");function darkMode(){$(".toggle-track").on("click",function(){html.hasClass("dark-mode")?(html.removeClass("dark-mode"),localStorage.setItem("dark_mode",!1)):(html.addClass("dark-mode"),localStorage.setItem("dark_mode",!0))})}function whiteLogo(){if(""!=themeOptions.white_logo){var e='<img class="logo-image white" src="'+themeOptions.white_logo+'">';$(".logo").append(e)}}function featured(){var e,o,n=$(".featured-posts"),i=n.find(".post-image");function a(){e=i.height(),o||(o=n.find(".owl-prev, .owl-next")),o.css({top:e/2+"px",opacity:1})}n.owlCarousel({dots:!1,margin:30,nav:!0,navText:['<i class="icon icon-chevron-left"></i>','<i class="icon icon-chevron-right"></i>'],onInitialized:function(){a()},onResized:function(){a()},responsive:{0:{items:1},768:{items:3},992:{items:4}}})}function gallery(){document.querySelectorAll(".kg-gallery-image img").forEach(function(e){var o=e.closest(".kg-gallery-image"),n=e.attributes.width.value/e.attributes.height.value;o.style.flex=n+" 1 0%"})}function comment(){""==themeOptions.disqus_shortname&&$(".comment-container").remove()}function author(){$(".author-name").on("click",function(){$(this).next(".author-social").toggleClass("enabled")})}function offCanvas(){var e=jQuery(".burger"),o=jQuery(".canvas-close");jQuery(".nav-list").slicknav({label:"",prependTo:".mobile-menu"}),e.on("click",function(){html.toggleClass("canvas-opened"),html.addClass("canvas-visible"),dimmer("open","medium")}),o.on("click",function(){html.hasClass("canvas-opened")&&(html.removeClass("canvas-opened"),dimmer("close","medium"))}),jQuery(".dimmer").on("click",function(){html.hasClass("canvas-opened")&&(html.removeClass("canvas-opened"),dimmer("close","medium"))}),jQuery(document).keyup(function(e){27==e.keyCode&&html.hasClass("canvas-opened")&&(html.removeClass("canvas-opened"),dimmer("close","medium"))})}function copyright(){""!=themeOptions.copyright&&$(".copyright").html(themeOptions.copyright)}function social(){var e={facebook:{name:"Facebook",icon:"facebook"},twitter:{name:"Twitter",icon:"twitter"},instagram:{name:"Instagram",icon:"instagram"},dribbble:{name:"Dribbble",icon:"dribbble"},behance:{name:"Behance",icon:"behance"},github:{name:"GitHub",icon:"github-circle"},linkedin:{name:"LinkedIn",icon:"linkedin"},vk:{name:"VK",icon:"vk"},rss:{name:"RSS",icon:"rss"}},o=themeOptions.social_links,n="";for(var i in o)""!=o[i]&&(n+='<a class="footer-social-item" href="'+o[i]+'" target="_blank"><i class="icon icon-'+e[i].icon+'"></i></a>');$(".footer-social").html(n)}function dimmer(e,o){"use strict";var n=jQuery(".dimmer");switch(e){case"open":n.fadeIn(o);break;case"close":n.fadeOut(o)}}$(function(){darkMode(),whiteLogo(),featured(),gallery(),comment(),author(),offCanvas(),copyright(),social()});